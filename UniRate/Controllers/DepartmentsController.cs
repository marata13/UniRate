...
namespace UniRate.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(UniRateContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,School,Name,EntranceGrade,StudyDuration,Directions,SubjectCount,SiteUrl,Phone,Address,Email,LocationUrl")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'UniRateContext.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
